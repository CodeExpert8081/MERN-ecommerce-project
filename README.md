...
The frontend of the application is built with ReactJS, Material UI, React-router-dom,ContextAPI. The source code for the frontend can be found at [https://github.com/CodeExpert8081/MERN-ecommerce-project](https://github.com/CodeExpert8081/MERN-ecommerce-project).
